...
from desktop_updater.client_config import resolve_update_share_root
from desktop_updater.manifest import (
    UpdateManifest,
    UpdateManifestError,
...
from desktop_updater.version_compare import is_newer_version, parse_version
...
def _scan_platform_dir(
    ...
    *,
    ...
    platform_names = get_config().platform_exe_names()
    payload_name = exe_name or platform_names.get(platform, get_config().exe_name)
...
def scan_update_candidates(
    ...
    *,
    ...
    cfg = get_config()
    platforms = (platform,) if platform else cfg.platform_subdirs
