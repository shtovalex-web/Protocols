...
Родительный падеж: при установленных **pymorphy3** (+ pymorphy3-dicts-ru) или pymorphy2;
иначе текст без склонения. Рекомендуется: pip install pymorphy3 pymorphy3-dicts-ru
